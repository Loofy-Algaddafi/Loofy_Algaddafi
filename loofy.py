    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.facebook.com/ingrid.jeancharles.585')
                time.sleep(2)
                menu()
